...
- `story_key` is unset
- `C:\code\panda/_bmad-output/implementation-artifacts/sprint-status.yaml` does not exist on disk

## Instructions

1. Load the FULL `C:\code\panda/_bmad-output/implementation-artifacts/sprint-status.yaml` file.
